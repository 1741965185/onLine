"use strict";
let crypto = require('@okxweb3/crypto-lib');
let wasm;
...
function getStringFromWasm0(ptr, len) {
    return crypto.base.fromUtf8(getUint8Memory0().subarray(ptr, ptr + len));
}
...
function zksync_crypto_init() {
    wasm.zksync_crypto_init();
}
exports.zksync_crypto_init = zksync_crypto_init;
...
function private_key_to_pubkey_hash(private_key) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.private_key_to_pubkey_hash = private_key_to_pubkey_hash;
function private_key_to_pubkey(private_key) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
...
exports.private_key_to_pubkey = private_key_to_pubkey;
function rescueHash(msg) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.rescueHash = rescueHash;
function rescueHashOrders(msg) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
...
function sign_musig(private_key, msg) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
...
exports.sign_musig = sign_musig;
function verify_musig(msg, signature) {
    var ptr0 = passArray8ToWasm0(msg, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
...
const encodeString = function (arg, view) {
    const buf = crypto.base.toUtf8(arg);
    view.set(buf);
    return {
        read: arg.length,
        written: buf.length
...
function base64ToArrayBuffer(base64) {
    return crypto.base.fromBase64(base64);
}
async function loadZkSyncCrypto() {
    const wasmBytes = base64ToArrayBuffer(base64WasmCode);
    await init(wasmBytes);
}
exports.loadZkSyncCrypto = loadZkSyncCrypto;
//# sourceMappingURL=zksync-crypto-web.js.map