...
export declare function hexToBuff(hex: string): Buffer;
export declare function postConditionFromString(postCondition: string): PostCondition;
export declare function addHex(hexWithOutPrefix: string): string;
