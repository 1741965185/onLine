...
function hashStructuredData(structuredData) {
    return crypto_lib_1.base.sha256((0, clarity_1.serializeCV)(structuredData));
}
...
function signStructuredData({ message, domain, privateKey, }) {
    const structuredDataHash = (0, common_1.bytesToHex)(crypto_lib_1.base.sha256(encodeStructuredData({ message, domain })));
