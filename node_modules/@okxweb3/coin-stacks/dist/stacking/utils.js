...
function _poxAddressToBtcAddress_Values(version, hashBytes, network) {
    ...
    switch (version) {
        ...
        case constants_1.PoXAddressVersion.P2WSH: {
            const words = crypto_lib_1.base.bech32.toWords(hashBytes);
            return crypto_lib_1.base.bech32.encode(constants_1.SegwitPrefix[network], [constants_1.SEGWIT_V0, ...words]);
        }
        case constants_1.PoXAddressVersion.P2TR: {
            const words = crypto_lib_1.base.bech32m.toWords(hashBytes);
            return crypto_lib_1.base.bech32m.encode(constants_1.SegwitPrefix[network], [constants_1.SEGWIT_V1, ...words]);
        }
    }
