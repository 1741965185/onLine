import { BufferCV, ClarityValue, OptionalCV, TupleCV } from '../transactions';
...
export declare function poxAddressToBtcAddress(version: number, hashBytes: Uint8Array, network: 'mainnet' | 'testnet' | 'regtest'): string;
export declare function poxAddressToBtcAddress(poxAddrClarityValue: ClarityValue, network: 'mainnet' | 'testnet' | 'regtest'): string;
...
export declare function ensurePox2Activated(operationInfo: PoxOperationInfo): void;
