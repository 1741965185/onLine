...
export default {
	data() {
		return {
			...
			currencyImagesOne: [
				{ filename: '/currency/USDC.png', title: 'USDC' },
				{ filename: '/currency/USDT.png', title: 'USDT' },
				{ filename: '/currency/BTC.png', title: 'BTC' },
				{ filename: '/currency/ETH.png', title: 'ETH' }
			],
			currencyImagesTwo: [
				{ filename: '/currency/USDC.png', title: 'USDC' },
				{ filename: '/currency/USDT.png', title: 'USDT' },
			...
			isTwo: false,
			isThree: false,
			selectedCurrencyIcon: '/currency/USDC.png',
			paymentAmount: '',
			paymentCurrency: '',
			...
			payAmount: '',
			payCurrency: 'USDC',
			payCurrencyIcon: '/currency/USDC.png',
			loading: false,
