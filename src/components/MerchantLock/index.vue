<template>
  <div>
    ...
    <el-tabs>
      <!-- 个人信息 -->
      <el-tab-pane>
                <span slot="label" @click="personInfo_head" class="w_h_max">
                    <i class="el-icon-user"></i> {{$t('editMerchant.personalInfo')}}
                </span>
          ...
          <div class="flex_l_r">
            <div class="W_half">
              <div class="flex_l_r line_height">
                <div>商户名</div>
                <div class="margin_empty">王四</div>
              </div>
              <div class="flex_l_r line_height">
                <div>联系电话</div>
                <div class="margin_empty">13988995678</div>
              </div>
              <div class="flex_l_r line_height">
                <div>邮箱</div>
                <div>
                  <span class="margin_r">info@softio.com</span>
                  <span>
                                        <el-switch v-model="switch_value1" active-color="#7F8DFF"
                                                   inactive-color="#E5E9F2"></el-switch>
                                    </span>
                </div>
              </div>
              <div class="flex_l_r line_height">
              ...
              <div class="flex_l_r line_height">
                <div>网址</div>
                <div class="margin_empty">http://www.domain.com</div>
              </div>
            </div>
            <!-- 右边 -->
            <div class="W_half">
              <div class="flex_l_r line_height">
                <div>PrivateKey</div>
                <div>XeJrYpPrbbbb</div>
              </div>
              <div class="flex_l_r line_height">
                <div>注册日期</div>
                <div>2020-03-10 15:58:04.0</div>
              </div>
              <div class="flex_l_r line_height">
                <div>类型</div>
                <div>
          ...
          <el-table
            ...
            <el-table-column
              ...
              <el-popover
                ...
                <template #reference>
                  <div class="icon-hover-effect" @click="visible = true">
        ...
        <div class="font_color">
          ...
          <el-table
            ...
            <el-table-column
              ...
              <!--  </div>-->
              <!--  <template #reference>-->
              <!--    <div href="#" class="icon-hover-effect" @click="visible = true">-->
              <!--      <em class="el-icon-more"></em>-->
              <!--    </div>-->
              <!--  </template>-->
              <!--</el-popover>-->
